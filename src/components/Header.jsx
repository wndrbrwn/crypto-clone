    ...
    <header className="sticky top-0 z-10">
      <div className="container-style flex justify-between items-center">
        <div className="flex items-center">
          <div className="p-6">
            <img className="w-[200px]" src={Logo} alt="crypto_logo" />
          </div>
          </div>
        <div className="flex pr-2 lg:pr-2">
        <nav className="hidden lg:flex">
            <button className="nav-button-style">Courses</button>
            <button className="nav-button-style">Register</button>
            <button className="nav-button-style">Sign In</button>
            <svg
                  ...
                  <button className="nav-button-style">English</button>
          </nav>
